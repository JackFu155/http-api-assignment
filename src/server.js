...
const urlStruct = {
  GET: {
    ...
    '/badRequest?valid=yeah': jsonHandler.badRequest,
    '/unauthorized?loggedIn=yeah': jsonHandler.unauthorized,
  ...
  HEAD: {
    ...
    '/badRequest?valid=yeah': jsonHandler.badRequestMeta,
    '/unauthorizedloggedIn=yeah': jsonHandler.unauthorizedMeta,
    '/forbidden': jsonHandler.forbiddenMeta,
    '/internal': jsonHandler.internalMeta,
    '/notImplemented': jsonHandler.notImplementedMeta,
    notFound: jsonHandler.notFoundMeta, // Mistake in completed Github version
  },
};
